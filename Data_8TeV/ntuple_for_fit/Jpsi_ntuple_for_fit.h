...
#ifndef Jpsi_ntuple_for_fit_h
#define Jpsi_ntuple_for_fit_h
...
class Jpsi_ntuple_for_fit : public TSelector {
public :
   ...
   Jpsi_ntuple_for_fit(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Jpsi_ntuple_for_fit() { }
   ...
   ClassDef(Jpsi_ntuple_for_fit,0);
};

#endif

#ifdef Jpsi_ntuple_for_fit_cxx
void Jpsi_ntuple_for_fit::Init(TTree *tree)
{
...
Bool_t Jpsi_ntuple_for_fit::Notify()
{
...
#endif // #ifdef Jpsi_ntuple_for_fit_cxx
