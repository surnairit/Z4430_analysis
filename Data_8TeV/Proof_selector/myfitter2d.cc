...
//#define SOURCE		    "/lustre/cms/store/user/nsur/Jpsi_8TeV_data_small_ntuples/MuOniaRun2012B_08Oct_MuMuKPiPAT_ntpl_merged_0000_1-500.root"
#define SOURCE              "MuMuPiK_Jpsi_MuOnia2012B_output_small_ntpls.root"
...
//    TTree *tin = (TTree*)fin->Get("Z_data");
    TNtupleD *tin = (TNtupleD*)fin->Get("_nt");
    //    if (!tin) cout <<"\nNo TTree \"mkcands/Z_data\" found in file \"" <<fin->GetName() <<"\"" <<endl;
    if (!tin) cout <<"\nNo TNtupleD \"_nt\" found in file \"" <<fin->GetName() <<"\"" <<endl;
//    else cout <<"\nTTree \"mkcands/Z_data\" found in file \"" <<fin->GetName() <<"\"" <<endl;
    else cout <<"\nTNtupleD \"_nt\" found in file \"" <<fin->GetName() <<"\"" <<endl;
