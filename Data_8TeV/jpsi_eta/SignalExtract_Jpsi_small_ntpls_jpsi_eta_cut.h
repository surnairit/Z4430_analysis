...
#ifndef SignalExtract_Jpsi_small_ntpls_jpsi_eta_cut_h
#define SignalExtract_Jpsi_small_ntpls_jpsi_eta_cut_h
...
class SignalExtract_Jpsi_small_ntpls_jpsi_eta_cut : public TSelector {
public :
   ...
   SignalExtract_Jpsi_small_ntpls_jpsi_eta_cut(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~SignalExtract_Jpsi_small_ntpls_jpsi_eta_cut() { }
   ...
   ///////////// Output files //////////////////
    ...
    TH1F* hjpsiKPiMassSelAlt_etacut_1sigma;
    TH1F* hjpsiKPiMassSelAlt_etacut_2sigma;
    TH1F* hjpsiKPiMassSelAlt_etacut_3sigma;
    

    Double_t muon_mass, phi_mass, jpsi_mass, psi2S_mass, pionCh_mass, kaonCh_mass, beam_energy;
    

   ClassDef(SignalExtract_Jpsi_small_ntpls_jpsi_eta_cut,0);
};

#endif

#ifdef SignalExtract_Jpsi_small_ntpls_jpsi_eta_cut_cxx
void SignalExtract_Jpsi_small_ntpls_jpsi_eta_cut::Init(TTree *tree)
{
...
Bool_t SignalExtract_Jpsi_small_ntpls_jpsi_eta_cut::Notify()
{
...
#endif // #ifdef SignalExtract_Jpsi_small_ntpls_jpsi_eta_cut_cxx
