...
#ifndef SignalExtract_Jpsi_small_ntpls_jpsi_eta_h
#define SignalExtract_Jpsi_small_ntpls_jpsi_eta_h
...
class SignalExtract_Jpsi_small_ntpls_jpsi_eta : public TSelector {
public :
   ...
   SignalExtract_Jpsi_small_ntpls_jpsi_eta(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~SignalExtract_Jpsi_small_ntpls_jpsi_eta() { }
   ...
   ///////////// Output files //////////////////
    ...
    TH1F* hjpsiMass_eta_bin[21];
    TH1F* hjpsiMass_eta_bin_sel[21];
    

    Double_t muon_mass, phi_mass, jpsi_mass, psi2S_mass, pionCh_mass, kaonCh_mass, beam_energy;
    

   ClassDef(SignalExtract_Jpsi_small_ntpls_jpsi_eta,0);
};

#endif

#ifdef SignalExtract_Jpsi_small_ntpls_jpsi_eta_cxx
void SignalExtract_Jpsi_small_ntpls_jpsi_eta::Init(TTree *tree)
{
...
Bool_t SignalExtract_Jpsi_small_ntpls_jpsi_eta::Notify()
{
...
#endif // #ifdef SignalExtract_Jpsi_small_ntpls_jpsi_eta_cxx
