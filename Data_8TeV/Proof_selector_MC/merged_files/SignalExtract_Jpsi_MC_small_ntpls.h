...
// Wed Apr 20 18:06:22 2016 by ROOT version 5.34/32
// from TTree Z_data/Z(4430) Data
// found on file: officialBdToJpsiKpi_MuMuPiKPAT_60000_small_ntpls_merged.root
//////////////////////////////////////////////////////////

#ifndef SignalExtract_Jpsi_MC_small_ntpls_h
#define SignalExtract_Jpsi_MC_small_ntpls_h
...
class SignalExtract_Jpsi_MC_small_ntpls : public TSelector {
public :
   ...
   SignalExtract_Jpsi_MC_small_ntpls(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~SignalExtract_Jpsi_MC_small_ntpls() { }
   ...
   ClassDef(SignalExtract_Jpsi_MC_small_ntpls,0);
};

#endif

#ifdef SignalExtract_Jpsi_MC_small_ntpls_cxx
void SignalExtract_Jpsi_MC_small_ntpls::Init(TTree *tree)
{
...
Bool_t SignalExtract_Jpsi_MC_small_ntpls::Notify()
{
...
#endif // #ifdef SignalExtract_Jpsi_MC_small_ntpls_cxx
