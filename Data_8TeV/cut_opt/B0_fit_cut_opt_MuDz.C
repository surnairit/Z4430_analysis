...
//  TFile *f0 = new TFile("psi2spipi_cut_opt_trial.root");
  ...
  TFile *f0 = new TFile("MuMuPiK_Jpsi_MuOnia2012ABCD_output_small_ntpls_cut_opt_MuDz.root");
  ofstream outfile;
  outfile.open("purity_MuOnia2012ABCD_MuDz.txt");
...
//  int n_gr = 23;
  double x[29],y[29],x_err[29],y_err[29];
...
//  gr->GetXaxis()->SetTitle("ChiSquared/NDoF cut ");
  ...
  c_purity->SaveAs("purity_MuOnia2012ABCD_MuDz.pdf");
