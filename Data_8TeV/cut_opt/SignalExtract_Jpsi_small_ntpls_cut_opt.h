...
#ifndef SignalExtract_Jpsi_small_ntpls_cut_opt_h
#define SignalExtract_Jpsi_small_ntpls_cut_opt_h
...
class SignalExtract_Jpsi_small_ntpls_cut_opt : public TSelector {
public :
   ...
   SignalExtract_Jpsi_small_ntpls_cut_opt(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~SignalExtract_Jpsi_small_ntpls_cut_opt() { }
   ...
   ///////////// Output files //////////////////
    ...
    //   TH1F* hjpsiKPiMassSelAltZoom_MuChi2_by_NDF[21];
    //   TH1F* hjpsiKPiMassSelAltZoom_MuS_hits[21];
    //   TH1F* hjpsiKPiMassSelAltZoom_MuP_hits[11];
    //   TH1F* hjpsiKPiMassSelAltZoom_MuDz[30];
    //   TH1F* hjpsiKPiMassSelAltZoom_MuDxy[11];
    
    //    TH1F* hjpsiKPiMassSelAltZoom_B0CosAlphaPV[20];
    //    TH1F* hjpsiKPiMassSelAltZoom_B0Vtx_CL[10];
    //      TH1F* hjpsiKPiMassSelAltZoom_B0CTauPV[10];
    //     TH1F* hjpsiKPiMassSelAltZoom_MuMuVtx_CL[10];
    //     TH1F* hjpsiKPiMassSelAltZoom_B0Pt[20];
    //    TH1F* hjpsiKPiMassSelAltZoom_trackPt[40];
          TH1F* hjpsiKPiMassSelAltZoom_MuMu_Track_deltaR[7];
   ...
   ClassDef(SignalExtract_Jpsi_small_ntpls_cut_opt,0);
};

#endif

#ifdef SignalExtract_Jpsi_small_ntpls_cut_opt_cxx
void SignalExtract_Jpsi_small_ntpls_cut_opt::Init(TTree *tree)
{
...
Bool_t SignalExtract_Jpsi_small_ntpls_cut_opt::Notify()
{
...
#endif // #ifdef SignalExtract_Jpsi_small_ntpls_cut_opt_cxx
