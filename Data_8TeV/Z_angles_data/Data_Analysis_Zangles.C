...
void Data_Analysis_Zangles::SlaveBegin(TTree * /*tree*/)
{
    ...
    h_phitilde_sel_nB01       = new TH1F("h_phitilde_sel_nB01","Angle between #mu+#pi and K#pi planes after selection _nB01;#tilde{#phi}", 160, -3.2, 3.2) ;
...
//================ Theta tilde =======================
double Data_Analysis_Zangles::costhetatilde(double theta, double phi, double m2kpi, double m2jpsipi) const
{
...
//================ phi tilde =======================
double Data_Analysis_Zangles::phitilde(double theta, double phi, double m2kpi, double m2jpsipi) const
{
    // K momentum in B0 frame
    double pk_B0 = dec2mm(B0_mass,sqrt(m2jpsipi),kaonCh_mass);
    TLorentzVector K_B0;
