...
#ifndef Data_Analysis_Zangles_h
#define Data_Analysis_Zangles_h
...
class Data_Analysis_Zangles : public TSelector {
    public :
    ...
    Data_Analysis_Zangles(TTree * /*tree*/ =0) : fChain(0) { }
    virtual ~Data_Analysis_Zangles() { }
...
#ifdef Data_Analysis_Zangles_cxx
void Data_Analysis_Zangles::Init(TTree *tree)
{
    ...
    m2B = B0_mass*B0_mass;        // [GeV]^2 B0 mass squared
    m2K = kaonCh_mass*kaonCh_mass;     // [GeV]^2 Kaon mass squared
    m2Pi = pionCh_mass*pionCh_mass;     // [GeV]^2 Pion mass squared
    m2Jpsi = jpsi_mass*jpsi_mass;    // [GeV]^2 Jpsi mass squared
...
Bool_t Data_Analysis_Zangles::Notify()
{
...
#endif // #ifdef Data_Analysis_Zangles_cxx
