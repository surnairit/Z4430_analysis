...
#ifndef BkgAnalysis_Jpsi_small_ntpls_h
#define BkgAnalysis_Jpsi_small_ntpls_h
...
class BkgAnalysis_Jpsi_small_ntpls : public TSelector {
public :
   ...
   BkgAnalysis_Jpsi_small_ntpls(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~BkgAnalysis_Jpsi_small_ntpls() { }
...
//************** baseline cuts ************************
    ...
    TH1F* hjpsiPiPiMass_noK892;
    TH1F* hjpsiPiPiMass_noK892_discard;
...
//************** hard cuts **************************
    TH1F* hJpsiPiMass_hard;
    TH1F* hKPiMass_hard;
    TH1F* hKPiRevMass_hard;
    TH1F* hPiPiMass_hard;
    TH1F* hKKMass_hard;
    TH1F* hKProtonMass_hard;
    TH1F* hPiProtonMass_hard;
    TH1F* hKPiMass_noBs_hard;
    
    TH1F* hJpsiPiMass_peak_hard;
    TH1F* hKPiMass_peak_hard;
    TH1F* hKPiRevMass_peak_hard;
    TH1F* hPiPiMass_peak_hard;
    TH1F* hKProtonMass_peak_hard;
    TH1F* hPiProtonMass_peak_hard;
    TH1F* hKKMass_peak_hard;

    TH1F* hJpsiPiMass_sb_hard;
    TH1F* hKPiMass_sb_hard;
    TH1F* hKPiRevMass_sb_hard;
    TH1F* hPiPiMass_sb_hard;
    TH1F* hKProtonMass_sb_hard;
    TH1F* hPiProtonMass_sb_hard;
    TH1F* hKKMass_sb_hard;
    
    TH1F* hjpsiKPiMassBaseSelAlt_hard;
    TH1F* hjpsiKPiRevMassBaseSelAlt_hard;
    TH1F* hjpsiKKMassBaseSelAlt_hard;
    TH1F* hjpsiPiPiMassBaseSelAlt_hard;
    TH1F* hjpsiPiPiMass_noK892_hard;
    TH1F* hjpsiPiPiMass_noK892_discard_hard;
    TH1F* hjpsiKProtonMassBaseSelAlt_hard;
    TH1F* hjpsiPiProtonMassBaseSelAlt_hard;
    TH1F* hjpsiPhiToKKMass_hard;
    TH1F* hjpsiKPiMassNoPhi_hard;
    TH1F* hjpsiKPiMassNoPhi_discard_hard;
    TH1F* hjpsiPiPiMassNoPhi_hard;
    TH1F* hjpsiPiPiMassNoPhi_discard_hard;

    TH2F* hJpsiKPi_JpsiKKBaseSelAlt_hard;
    TH2F* hJpsiKPi_JpsiPiPiBaseSelAlt_hard;
    TH2F* hJpsiKPi_JpsiPiProtonBaseSelAlt_hard;
    TH2F* hJpsiKPi_JpsiKProtonBaseSelAlt_hard;
    
    TH2F* hDalitz_peak_hard;
    TH2F* hDalitz_sideband_hard;
...
//************** hard cuts **************************
   ...
   ClassDef(BkgAnalysis_Jpsi_small_ntpls,0);
};

#endif

#ifdef BkgAnalysis_Jpsi_small_ntpls_cxx
void BkgAnalysis_Jpsi_small_ntpls::Init(TTree *tree)
{
...
Bool_t BkgAnalysis_Jpsi_small_ntpls::Notify()
{
...
#endif // #ifdef BkgAnalysis_Jpsi_small_ntpls_cxx
