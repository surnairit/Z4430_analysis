#define BkgAnalysis_Jpsi_small_ntpls_cxx
// The class definition in BkgAnalysis_Jpsi_small_ntpls.h has been generated automatically
...
//
// Root > T->Process("BkgAnalysis_Jpsi_small_ntpls.C")
// Root > T->Process("BkgAnalysis_Jpsi_small_ntpls.C","some options")
// Root > T->Process("BkgAnalysis_Jpsi_small_ntpls.C+")
//

#include "BkgAnalysis_Jpsi_small_ntpls.h"
#include <TH2.h>
#include <TStyle.h>
...
void BkgAnalysis_Jpsi_small_ntpls::Begin(TTree * /*tree*/)
{
...
void BkgAnalysis_Jpsi_small_ntpls::SlaveBegin(TTree * /*tree*/)
{
   ...
   TString option = GetOption();
     ...
     OutFile = new TProofOutputFile( "MuMuPiK_Jpsi_MuOnia2012ABCD_BkgAnalysis.root" );
...
Bool_t BkgAnalysis_Jpsi_small_ntpls::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either BkgAnalysis_Jpsi_small_ntpls::GetEntry() or TBranch::GetEntry()
...
void BkgAnalysis_Jpsi_small_ntpls::SlaveTerminate()
{
...
void BkgAnalysis_Jpsi_small_ntpls::Terminate()
{
