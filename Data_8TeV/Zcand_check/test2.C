...
//=========  (Wed Jan  4 12:22:25 2017) by ROOT version5.34/32
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",260,93,536,324);
   Canvas_1->Range(-1.25,-1067979,11.25,9611810);
   ...
   TPaveText *pt = new TPaveText(0.4450562,0.94,0.5549438,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
