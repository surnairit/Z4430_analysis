...
// Fri Oct 23 17:26:21 2015 by ROOT version 5.32/00
// from TTree Z_data/Z(4430) Data
// found on file: MuOniaRun2012B_08Oct_MuMuKPiPAT_ntpl_merged_0000_1000-1999.root
//////////////////////////////////////////////////////////

#ifndef SignalExtract_Jpsi_small_ntpls_h
#define SignalExtract_Jpsi_small_ntpls_h
...
class SignalExtract_Jpsi_small_ntpls : public TSelector {
public :
   ...
   SignalExtract_Jpsi_small_ntpls(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~SignalExtract_Jpsi_small_ntpls() { }
   ...
   ///////////// Output files //////////////////
    ...
    TH1F* h_theta_Jpsi;
    TH1F* h_cos_theta_Jpsi;
    TH1F* h_theta_Jpsi_sel;
    TH1F* h_cos_theta_Jpsi_sel;
    
    TH1F* h_theta_Kstar;
    TH1F* h_cos_theta_Kstar;
    TH1F* h_theta_Kstar_sel;
    TH1F* h_cos_theta_Kstar_sel;
    
    TH1F* h_phi_planes;
    TH1F* h_phi_planes_sel;
    
    TH1F* h_theta_Jpsi_Trackpt4p3;
    TH1F* h_theta_Kstar_Trackpt4p3;
    TH1F* h_phi_planes_Trackpt4p3;

// nB0 = 1 variables
    
    TH1F* h_theta_Jpsi_sel_nB01;
    TH1F* h_cos_theta_Jpsi_sel_nB01;
    TH1F* h_theta_Kstar_sel_nB01;
    TH1F* h_cos_theta_Kstar_sel_nB01;
    TH1F* h_phi_planes_sel_nB01;
    
    TH1F* hjpsiKPiMassSelAltZoom_nB01;
    TH1F* hjpsiKPiMass_noKstar_nB01;
    
    TH1F* hjpsiKPiMassSelAltZoomB0pt18_nB0eq1;
    TH1F* hjpsiKPiMassSelAltZoomTrackpt4p3_nB0eq1;
    TH1F* hjpsiKPiMassSelAltZoomB0pt18Trackpt4p3_nB0eq1;
    
    
    TH1F* hjpsiKPiMassSelAltZoomTrackpt2p5_nB0eq1;
    TH1F* hjpsiKPiMassSelAltZoomB0pt18Trackpt2p5_nB0eq1;
    
    TH1F* hjpsiPiMass_nB01;
    TH1F* hjpsiPiMass_noKstar_nB01;
    TH1F* hjpsiPiMass2_nB01;
    TH1F* hjpsiPiMass2_noKstar_nB01;
    TH1F* hjpsiPiMass2_nB01_case1;
    TH1F* hjpsiPiMass2_nB01_case2;
    TH1F* hjpsiPiMass2_nB01_case3;
    TH1F* hjpsiPiMass2_nB01_case4;
    
    TH2F* hDalitz_peak_nB01_bin1;
    TH2F* hDalitz_sideband_nB01_bin1;
    TH2F* hDalitz_peak_nB01_bin2;
    TH2F* hDalitz_sideband_nB01_bin2;
    TH2F* hDalitz_peak_nB01_bin3;
    TH2F* hDalitz_sideband_nB01_bin3;
    TH2F* hDalitz_peak_nB01_bin4;
    TH2F* hDalitz_sideband_nB01_bin4;
    
    TH1F* hDalitzProj_m2KPi_nB01_peak;
    TH1F* hDalitzProj_m2JpsiPi_nB01_peak;
    TH1F* hDalitzProj_m2KPi_nB01_sideband;
    TH1F* hDalitzProj_m2JpsiPi_nB01_sideband;
...
// nB0 = 1 variables
    ...
    TH1F* hKPiMass_noBs;
    TH1F* hKKMassB0;
    TH1F* hKKMass_control;
    TH1F* hPiPiMassB0;
    TH1F* hPiPiMassPsi2S;
    TH1F* hJpsiKKMass;
    TH1F* hJpsiKKMass_control;
    TH1F* hJpsiPiPiMass;
    TH1F* hJpsiPhiToKKMass;
    TH1F* hJpsif1525ToKKMass;
    
    TH1F* hPiPiMassB0_noVertexCut;
    TH1F* hjpsiPiMass;
    TH1F* hjpsiPiMass_noKstar;
    
    TH1F* hjpsiPiMass2;
    TH1F* hjpsiPiMass2_noKstar;
    
    TH1F* hjpsiPiMass2_case1;
    TH1F* hjpsiPiMass2_case2;
    TH1F* hjpsiPiMass2_case3;
    TH1F* hjpsiPiMass2_case4;
    TH1F* hjpsiPiMass2_sb;
    
    TH1F* hjpsiKPiMass_noKstar;

    TH1F* hjpsiKPiMassSelAlt  ;
    TH1F* hjpsiKPiMassSelAltZoom ;
    TH1F* hjpsiKPiMassNoPhi;
    TH1F* hjpsiKPiMassBsTail;
    TH1F* hjpsiKPiMassBs;
    
    TH1F* hjpsiKPiMassBaseSelAlt;
    
    TH2F* hJpsiKPi_JpsiKK;
    ...
    TH2F* hPiPi_KK;
    TH2F* hPiPi_KPi;
    TH2F* hPiPi_KPi_swapped;
    TH2F* hKK_KPi;
    TH2F* hKK_KPi_swapped;
    
    TH2F* hDalitz_peak_bin1;
    TH2F* hDalitz_sideband_bin1;
    TH2F* hDalitz_peak_bin2;
    TH2F* hDalitz_sideband_bin2;
    TH2F* hDalitz_peak_bin3;
    TH2F* hDalitz_sideband_bin3;
    TH2F* hDalitz_peak_bin4;
    TH2F* hDalitz_sideband_bin4;
    
    TH1F* hDalitzProj_m2KPi_peak;
    TH1F* hDalitzProj_m2JpsiPi_peak;
    TH1F* hDalitzProj_m2KPi_sideband;
    TH1F* hDalitzProj_m2JpsiPi_sideband;

    
    
    TH1F* hjpsiKPiMassSelAltZoomB0pt18;
    TH1F* hjpsiKPiMassSelAltZoomTrackpt4p3;
    TH1F* hjpsiKPiMassSelAltZoomB0pt18Trackpt4p3;
    ...
    double GetPhi(TLorentzVector LoreVecB0,TLorentzVector LoreVecMum, TLorentzVector LoreVecMup, TLorentzVector LoreVecK, TLorentzVector LoreVecPi);

   ClassDef(SignalExtract_Jpsi_small_ntpls,0);
};

#endif

#ifdef SignalExtract_Jpsi_small_ntpls_cxx
void SignalExtract_Jpsi_small_ntpls::Init(TTree *tree)
{
...
Bool_t SignalExtract_Jpsi_small_ntpls::Notify()
{
...
#endif // #ifdef SignalExtract_Jpsi_small_ntpls_cxx
