...
#                        mylist.extend ( FileUtils.loadListFromFile ('filenames_set2_0000.txt') )
                        ...
                        # offcial MC                              
                        mylist = FileUtils.loadListFromFile ('filenames_official_formatted_80000_80.txt')
                        #mylist.extend ( FileUtils.loadListFromFile ('filenames_official_formatted_10000.txt') )
                        #mylist.extend ( FileUtils.loadListFromFile ('filenames_official_formatted_80000_80.txt') )
...
#                    process.TFileService.fileName = cms.string('officialBdToPsiKpi_18Mar_MuMuPiKPAT_ntpl.root')
                    process.TFileService.fileName = cms.string('/lustre/cms/store/user/nsur/Jpsi_8TeV_OfficialMC_small_ntuples/officialBdToJpsiKpi_MuMuPiKPAT_80000_80_small_ntpls.root')
    elif MCMotherId == 531 :
