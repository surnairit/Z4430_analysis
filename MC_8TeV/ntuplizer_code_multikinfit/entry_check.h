...
// Thu Jul 28 19:58:28 2016 by ROOT version 5.34/32
// from TTree Z_data/Z(4430) Data
// found on file: officialBdToPsiKpi_noPtEtaCut_MuMuPiKPAT_ntpl.root
//////////////////////////////////////////////////////////

#ifndef entry_check_h
#define entry_check_h
...
#ifdef entry_check_cxx
entry_check::entry_check(TTree *tree) : fChain(0) 
{
...
Int_t entry_check::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t entry_check::LoadTree(Long64_t entry)
{
...
void entry_check::Init(TTree *tree)
{
...
void entry_check::Show(Long64_t entry)
{
...
Int_t entry_check::Cut(Long64_t entry)
{
