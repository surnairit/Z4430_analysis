...
private:
  ...
  unsigned int          nB0_pre0, nB0_pre1, nB0_pre2, nB0_pre3, nB0_pre4, nB0_pre5, nB0_pre6, nB0_pre7, nB0_pre8, nB0_pre9, nB0_pre10, nB0_pre11, nB0_pre12, nB0_pre13, nB0_pre14, nB0massconst_notvalid ; // nsmod
...
/*
  float                 mu1Px_MuMuPiK_JpsiMass_val, mu1Py_MuMuPiK_JpsiMass_val, mu1Pz_MuMuPiK_JpsiMass_val, mu1E_MuMuPiK_JpsiMass_val ;
  float                 mu2Px_MuMuPiK_JpsiMass_val, mu2Py_MuMuPiK_JpsiMass_val, mu2Pz_MuMuPiK_JpsiMass_val, mu2E_MuMuPiK_JpsiMass_val ;
  float                 piPx_MuMuPiK_JpsiMass_val, piPy_MuMuPiK_JpsiMass_val, piPz_MuMuPiK_JpsiMass_val, piE_MuMuPiK_JpsiMass_val ;
  float                 kPx_MuMuPiK_JpsiMass_val, kPy_MuMuPiK_JpsiMass_val, kPz_MuMuPiK_JpsiMass_val, kE_MuMuPiK_JpsiMass_val ;
*/
  vector<float>         *b0Mass_B0const, *b0Mass_Jpsiconst ;
  // Muons and tracks after B0 cand fit with B0 mass constraint  // nsmod
...
/*
  ...
  vector<float>         *mu1Px_MuMuPiK_JpsiMass, *mu1Py_MuMuPiK_JpsiMass, *mu1Pz_MuMuPiK_JpsiMass, *mu1E_MuMuPiK_JpsiMass ;
  vector<float>         *mu2Px_MuMuPiK_JpsiMass, *mu2Py_MuMuPiK_JpsiMass, *mu2Pz_MuMuPiK_JpsiMass, *mu2E_MuMuPiK_JpsiMass ;
  vector<float>         *piPx_MuMuPiK_JpsiMass, *piPy_MuMuPiK_JpsiMass, *piPz_MuMuPiK_JpsiMass, *piE_MuMuPiK_JpsiMass ;
  vector<float>         *kPx_MuMuPiK_JpsiMass, *kPy_MuMuPiK_JpsiMass, *kPz_MuMuPiK_JpsiMass, *kE_MuMuPiK_JpsiMass ;

  // Muons and tracks after B0 cand fit with no mass constraint  // nsmod
  vector<float>         *mu1Px_MuMuPiK_NoMass, *mu1Py_MuMuPiK_NoMass, *mu1Pz_MuMuPiK_NoMass, *mu1E_MuMuPiK_NoMass ;
  vector<float>         *mu2Px_MuMuPiK_NoMass, *mu2Py_MuMuPiK_NoMass, *mu2Pz_MuMuPiK_NoMass, *mu2E_MuMuPiK_NoMass ;
  vector<float>         *piPx_MuMuPiK_NoMass, *piPy_MuMuPiK_NoMass, *piPz_MuMuPiK_NoMass, *piE_MuMuPiK_NoMass ;
  vector<float>         *kPx_MuMuPiK_NoMass, *kPy_MuMuPiK_NoMass, *kPz_MuMuPiK_NoMass, *kE_MuMuPiK_NoMass ;

  // B0 mass const relative change // nsmod
  vector<float>         *mu1Px_MuMuPiK_B0Mass_rel, *mu1Py_MuMuPiK_B0Mass_rel, *mu1Pz_MuMuPiK_B0Mass_rel, *mu1E_MuMuPiK_B0Mass_rel ;
  vector<float>         *mu2Px_MuMuPiK_B0Mass_rel, *mu2Py_MuMuPiK_B0Mass_rel, *mu2Pz_MuMuPiK_B0Mass_rel, *mu2E_MuMuPiK_B0Mass_rel ;
  vector<float>         *piPx_MuMuPiK_B0Mass_rel, *piPy_MuMuPiK_B0Mass_rel, *piPz_MuMuPiK_B0Mass_rel, *piE_MuMuPiK_B0Mass_rel ;
  vector<float>         *kPx_MuMuPiK_B0Mass_rel, *kPy_MuMuPiK_B0Mass_rel, *kPz_MuMuPiK_B0Mass_rel, *kE_MuMuPiK_B0Mass_rel ;

  // Jpsi mass const relative change // nsmod
  vector<float>         *mu1Px_MuMuPiK_JpsiMass_rel, *mu1Py_MuMuPiK_JpsiMass_rel, *mu1Pz_MuMuPiK_JpsiMass_rel, *mu1E_MuMuPiK_JpsiMass_rel ;
  vector<float>         *mu2Px_MuMuPiK_JpsiMass_rel, *mu2Py_MuMuPiK_JpsiMass_rel, *mu2Pz_MuMuPiK_JpsiMass_rel, *mu2E_MuMuPiK_JpsiMass_rel ;
  vector<float>         *piPx_MuMuPiK_JpsiMass_rel, *piPy_MuMuPiK_JpsiMass_rel, *piPz_MuMuPiK_JpsiMass_rel, *piE_MuMuPiK_JpsiMass_rel ;
  vector<float>         *kPx_MuMuPiK_JpsiMass_rel, *kPy_MuMuPiK_JpsiMass_rel, *kPz_MuMuPiK_JpsiMass_rel, *kE_MuMuPiK_JpsiMass_rel ;
*/    
