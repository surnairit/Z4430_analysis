...
// Tue Jul 26 21:21:47 2016 by ROOT version 5.34/32
// from TTree Z_data/Z(4430) Data
// found on file: officialBdToPsiKpi_noPtEtaCut_MuMuPiKPAT_ntpl_sequential_const.root
//////////////////////////////////////////////////////////

#ifndef KinFitCheck_h
#define KinFitCheck_h
...
#include "/usr/local/root/src/cint/cint/lib/prec_stl/vector"
#include "/usr/local/root/src/cint/cint/lib/prec_stl/vector"
#include "/usr/local/root/src/cint/cint/lib/prec_stl/vector"
#include "/usr/local/root/src/cint/cint/lib/prec_stl/vector"
#include "/usr/local/root/src/cint/cint/lib/prec_stl/vector"
...
public :
   ...
   vector<int>     *MCkaonCh;
   vector<float>   *MCkaonStarPx;
   vector<float>   *MCkaonStarPy;
   vector<float>   *MCkaonStarPz;
   vector<int>     *MCkaonStarCh;
   vector<float>   *MCkaonStarMass;
   vector<float>   *MCPx;
   vector<float>   *MCPy;
   vector<float>   *MCPz;
   UInt_t          nMu;
   ...
   vector<float>   *B0Mass_B0const;
   vector<float>   *B0Mass_Jpsiconst;
   vector<float>   *Muon1Px_MuMuPiK_B0Mass;
   vector<float>   *Muon1Py_MuMuPiK_B0Mass;
   vector<float>   *Muon1Pz_MuMuPiK_B0Mass;
   vector<float>   *Muon1E_MuMuPiK_B0Mass;
   vector<float>   *Muon2Px_MuMuPiK_B0Mass;
   vector<float>   *Muon2Py_MuMuPiK_B0Mass;
   vector<float>   *Muon2Pz_MuMuPiK_B0Mass;
   vector<float>   *Muon2E_MuMuPiK_B0Mass;
   vector<float>   *PionPx_MuMuPiK_B0Mass;
   vector<float>   *PionPy_MuMuPiK_B0Mass;
   vector<float>   *PionPz_MuMuPiK_B0Mass;
   vector<float>   *PionE_MuMuPiK_B0Mass;
   vector<float>   *KaonPx_MuMuPiK_B0Mass;
   vector<float>   *KaonPy_MuMuPiK_B0Mass;
   vector<float>   *KaonPz_MuMuPiK_B0Mass;
   vector<float>   *KaonE_MuMuPiK_B0Mass;
   vector<float>   *Muon1Px_MuMuPiK_JpsiMass;
   vector<float>   *Muon1Py_MuMuPiK_JpsiMass;
   vector<float>   *Muon1Pz_MuMuPiK_JpsiMass;
   vector<float>   *Muon1E_MuMuPiK_JpsiMass;
   vector<float>   *Muon2Px_MuMuPiK_JpsiMass;
   vector<float>   *Muon2Py_MuMuPiK_JpsiMass;
   vector<float>   *Muon2Pz_MuMuPiK_JpsiMass;
   vector<float>   *Muon2E_MuMuPiK_JpsiMass;
   vector<float>   *PionPx_MuMuPiK_JpsiMass;
   vector<float>   *PionPy_MuMuPiK_JpsiMass;
   vector<float>   *PionPz_MuMuPiK_JpsiMass;
   vector<float>   *PionE_MuMuPiK_JpsiMass;
   vector<float>   *KaonPx_MuMuPiK_JpsiMass;
   vector<float>   *KaonPy_MuMuPiK_JpsiMass;
   vector<float>   *KaonPz_MuMuPiK_JpsiMass;
   vector<float>   *KaonE_MuMuPiK_JpsiMass;
   vector<float>   *Muon1Px_MuMuPiK_NoMass;
   vector<float>   *Muon1Py_MuMuPiK_NoMass;
   vector<float>   *Muon1Pz_MuMuPiK_NoMass;
   vector<float>   *Muon1E_MuMuPiK_NoMass;
   vector<float>   *Muon2Px_MuMuPiK_NoMass;
   vector<float>   *Muon2Py_MuMuPiK_NoMass;
   vector<float>   *Muon2Pz_MuMuPiK_NoMass;
   vector<float>   *Muon2E_MuMuPiK_NoMass;
   vector<float>   *PionPx_MuMuPiK_NoMass;
   vector<float>   *PionPy_MuMuPiK_NoMass;
   vector<float>   *PionPz_MuMuPiK_NoMass;
   vector<float>   *PionE_MuMuPiK_NoMass;
   vector<float>   *KaonPx_MuMuPiK_NoMass;
   vector<float>   *KaonPy_MuMuPiK_NoMass;
   vector<float>   *KaonPz_MuMuPiK_NoMass;
   vector<float>   *KaonE_MuMuPiK_NoMass;
   vector<float>   *Muon1Px_MuMuPiK_B0Mass_rel;
   vector<float>   *Muon1Py_MuMuPiK_B0Mass_rel;
   vector<float>   *Muon1Pz_MuMuPiK_B0Mass_rel;
   vector<float>   *Muon1E_MuMuPiK_B0Mass_rel;
   vector<float>   *Muon2Px_MuMuPiK_B0Mass_rel;
   vector<float>   *Muon2Py_MuMuPiK_B0Mass_rel;
   vector<float>   *Muon2Pz_MuMuPiK_B0Mass_rel;
   vector<float>   *Muon2E_MuMuPiK_B0Mass_rel;
   vector<float>   *PionPx_MuMuPiK_B0Mass_rel;
   vector<float>   *PionPy_MuMuPiK_B0Mass_rel;
   vector<float>   *PionPz_MuMuPiK_B0Mass_rel;
   vector<float>   *PionE_MuMuPiK_B0Mass_rel;
   vector<float>   *KaonPx_MuMuPiK_B0Mass_rel;
   vector<float>   *KaonPy_MuMuPiK_B0Mass_rel;
   vector<float>   *KaonPz_MuMuPiK_B0Mass_rel;
   vector<float>   *KaonE_MuMuPiK_B0Mass_rel;
   vector<float>   *Muon1Px_MuMuPiK_JpsiMass_rel;
   vector<float>   *Muon1Py_MuMuPiK_JpsiMass_rel;
   vector<float>   *Muon1Pz_MuMuPiK_JpsiMass_rel;
   vector<float>   *Muon1E_MuMuPiK_JpsiMass_rel;
   vector<float>   *Muon2Px_MuMuPiK_JpsiMass_rel;
   vector<float>   *Muon2Py_MuMuPiK_JpsiMass_rel;
   vector<float>   *Muon2Pz_MuMuPiK_JpsiMass_rel;
   vector<float>   *Muon2E_MuMuPiK_JpsiMass_rel;
   vector<float>   *PionPx_MuMuPiK_JpsiMass_rel;
   vector<float>   *PionPy_MuMuPiK_JpsiMass_rel;
   vector<float>   *PionPz_MuMuPiK_JpsiMass_rel;
   vector<float>   *PionE_MuMuPiK_JpsiMass_rel;
   vector<float>   *KaonPx_MuMuPiK_JpsiMass_rel;
   vector<float>   *KaonPy_MuMuPiK_JpsiMass_rel;
   vector<float>   *KaonPz_MuMuPiK_JpsiMass_rel;
   vector<float>   *KaonE_MuMuPiK_JpsiMass_rel;
   UInt_t          nB0;
   UInt_t          nB0_pre0;
   UInt_t          nB0_pre1;
   UInt_t          nB0_pre2;
   ...
   TBranch        *b_genEvtVtx_particles;   //!
   TBranch        *b_n_B0Ancestors;   //!
   TBranch        *b_nMCAll;   //!
   TBranch        *b_MCPdgIdAll;   //!
   TBranch        *b_MCDanNumAll;   //!
   TBranch        *b_nMCB0;   //!
   ...
   TBranch        *b_MCkaonPz;   //!
   TBranch        *b_MCkaonCh;   //!
   TBranch        *b_MCkaonStarPx;   //!
   TBranch        *b_MCkaonStarPy;   //!
   TBranch        *b_MCkaonStarPz;   //!
   TBranch        *b_MCkaonStarCh;   //!
   TBranch        *b_MCkaonStarMass;   //!
   TBranch        *b_MCPx;   //!
   TBranch        *b_MCPy;   //!
   TBranch        *b_MCPz;   //!
   TBranch        *b_nMu;   //!
   ...
   TBranch        *b_B0Mass_B0const;   //!
   TBranch        *b_B0Mass_Jpsiconst;   //!
   TBranch        *b_Muon1Px_MuMuPiK_B0Mass;   //!
   TBranch        *b_Muon1Py_MuMuPiK_B0Mass;   //!
   TBranch        *b_Muon1Pz_MuMuPiK_B0Mass;   //!
   TBranch        *b_Muon1E_MuMuPiK_B0Mass;   //!
   TBranch        *b_Muon2Px_MuMuPiK_B0Mass;   //!
   TBranch        *b_Muon2Py_MuMuPiK_B0Mass;   //!
   TBranch        *b_Muon2Pz_MuMuPiK_B0Mass;   //!
   TBranch        *b_Muon2E_MuMuPiK_B0Mass;   //!
   TBranch        *b_PionPx_MuMuPiK_B0Mass;   //!
   TBranch        *b_PionPy_MuMuPiK_B0Mass;   //!
   TBranch        *b_PionPz_MuMuPiK_B0Mass;   //!
   TBranch        *b_PionE_MuMuPiK_B0Mass;   //!
   TBranch        *b_KaonPx_MuMuPiK_B0Mass;   //!
   TBranch        *b_KaonPy_MuMuPiK_B0Mass;   //!
   TBranch        *b_KaonPz_MuMuPiK_B0Mass;   //!
   TBranch        *b_KaonE_MuMuPiK_B0Mass;   //!
   TBranch        *b_Muon1Px_MuMuPiK_JpsiMass;   //!
   TBranch        *b_Muon1Py_MuMuPiK_JpsiMass;   //!
   TBranch        *b_Muon1Pz_MuMuPiK_JpsiMass;   //!
   TBranch        *b_Muon1E_MuMuPiK_JpsiMass;   //!
   TBranch        *b_Muon2Px_MuMuPiK_JpsiMass;   //!
   TBranch        *b_Muon2Py_MuMuPiK_JpsiMass;   //!
   TBranch        *b_Muon2Pz_MuMuPiK_JpsiMass;   //!
   TBranch        *b_Muon2E_MuMuPiK_JpsiMass;   //!
   TBranch        *b_PionPx_MuMuPiK_JpsiMass;   //!
   TBranch        *b_PionPy_MuMuPiK_JpsiMass;   //!
   TBranch        *b_PionPz_MuMuPiK_JpsiMass;   //!
   TBranch        *b_PionE_MuMuPiK_JpsiMass;   //!
   TBranch        *b_KaonPx_MuMuPiK_JpsiMass;   //!
   TBranch        *b_KaonPy_MuMuPiK_JpsiMass;   //!
   TBranch        *b_KaonPz_MuMuPiK_JpsiMass;   //!
   TBranch        *b_KaonE_MuMuPiK_JpsiMass;   //!
   TBranch        *b_Muon1Px_MuMuPiK_NoMass;   //!
   TBranch        *b_Muon1Py_MuMuPiK_NoMass;   //!
   TBranch        *b_Muon1Pz_MuMuPiK_NoMass;   //!
   TBranch        *b_Muon1E_MuMuPiK_NoMass;   //!
   TBranch        *b_Muon2Px_MuMuPiK_NoMass;   //!
   TBranch        *b_Muon2Py_MuMuPiK_NoMass;   //!
   TBranch        *b_Muon2Pz_MuMuPiK_NoMass;   //!
   TBranch        *b_Muon2E_MuMuPiK_NoMass;   //!
   TBranch        *b_PionPx_MuMuPiK_NoMass;   //!
   TBranch        *b_PionPy_MuMuPiK_NoMass;   //!
   TBranch        *b_PionPz_MuMuPiK_NoMass;   //!
   TBranch        *b_PionE_MuMuPiK_NoMass;   //!
   TBranch        *b_KaonPx_MuMuPiK_NoMass;   //!
   TBranch        *b_KaonPy_MuMuPiK_NoMass;   //!
   TBranch        *b_KaonPz_MuMuPiK_NoMass;   //!
   TBranch        *b_KaonE_MuMuPiK_NoMass;   //!
   TBranch        *b_Muon1Px_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_Muon1Py_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_Muon1Pz_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_Muon1E_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_Muon2Px_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_Muon2Py_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_Muon2Pz_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_Muon2E_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_PionPx_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_PionPy_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_PionPz_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_PionE_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_KaonPx_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_KaonPy_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_KaonPz_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_KaonE_MuMuPiK_B0Mass_rel;   //!
   TBranch        *b_Muon1Px_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_Muon1Py_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_Muon1Pz_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_Muon1E_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_Muon2Px_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_Muon2Py_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_Muon2Pz_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_Muon2E_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_PionPx_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_PionPy_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_PionPz_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_PionE_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_KaonPx_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_KaonPy_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_KaonPz_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_KaonE_MuMuPiK_JpsiMass_rel;   //!
   TBranch        *b_nB0;   //!
   TBranch        *b_nB0_pre0;   //!
   TBranch        *b_nB0_pre1;   //!
   TBranch        *b_nB0_pre2;   //!
   ...
   TBranch        *b_nB0_pre13;   //!
   TBranch        *b_nB0_pre14;   //!
   TBranch        *b_nB0massconst_notvalid;   //!
   TBranch        *b_B0Mass;   //!
   TBranch        *b_B0Px;   //!
   TBranch        *b_B0Py;   //!
   TBranch        *b_B0Pz;   //!
...
#ifdef KinFitCheck_cxx
KinFitCheck::KinFitCheck(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
//      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("officialBdToPsiKpi_noPtEtaCut_MuMuPiKPAT_ntpl_sequential_const_merged.root");
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("officialBdToPsiKpi_noPtEtaCut_MuMuPiKPAT_ntpl.root");
      if (!f || !f->IsOpen()) {
//         f = new TFile("officialBdToPsiKpi_noPtEtaCut_MuMuPiKPAT_ntpl_sequential_const_merged.root");
         f = new TFile("officialBdToPsiKpi_noPtEtaCut_MuMuPiKPAT_ntpl.root");
      }
//      TDirectory * dir = (TDirectory*)f->Get("officialBdToPsiKpi_noPtEtaCut_MuMuPiKPAT_ntpl_sequential_const_merged.root:/mkcands");
      TDirectory * dir = (TDirectory*)f->Get("officialBdToPsiKpi_noPtEtaCut_MuMuPiKPAT_ntpl.root:/mkcands");
...
KinFitCheck::~KinFitCheck()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t KinFitCheck::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t KinFitCheck::LoadTree(Long64_t entry)
{
...
void KinFitCheck::Init(TTree *tree)
{
   ...
   B0Mass_B0const = 0;
   B0Mass_Jpsiconst = 0;
   Muon1Px_MuMuPiK_B0Mass = 0;
   Muon1Py_MuMuPiK_B0Mass = 0;
   Muon1Pz_MuMuPiK_B0Mass = 0;
   Muon1E_MuMuPiK_B0Mass = 0;
   Muon2Px_MuMuPiK_B0Mass = 0;
   Muon2Py_MuMuPiK_B0Mass = 0;
   Muon2Pz_MuMuPiK_B0Mass = 0;
   Muon2E_MuMuPiK_B0Mass = 0;
   PionPx_MuMuPiK_B0Mass = 0;
   PionPy_MuMuPiK_B0Mass = 0;
   PionPz_MuMuPiK_B0Mass = 0;
   PionE_MuMuPiK_B0Mass = 0;
   KaonPx_MuMuPiK_B0Mass = 0;
   KaonPy_MuMuPiK_B0Mass = 0;
   KaonPz_MuMuPiK_B0Mass = 0;
   KaonE_MuMuPiK_B0Mass = 0;
   Muon1Px_MuMuPiK_JpsiMass = 0;
   Muon1Py_MuMuPiK_JpsiMass = 0;
   Muon1Pz_MuMuPiK_JpsiMass = 0;
   Muon1E_MuMuPiK_JpsiMass = 0;
   Muon2Px_MuMuPiK_JpsiMass = 0;
   Muon2Py_MuMuPiK_JpsiMass = 0;
   Muon2Pz_MuMuPiK_JpsiMass = 0;
   Muon2E_MuMuPiK_JpsiMass = 0;
   PionPx_MuMuPiK_JpsiMass = 0;
   PionPy_MuMuPiK_JpsiMass = 0;
   PionPz_MuMuPiK_JpsiMass = 0;
   PionE_MuMuPiK_JpsiMass = 0;
   KaonPx_MuMuPiK_JpsiMass = 0;
   KaonPy_MuMuPiK_JpsiMass = 0;
   KaonPz_MuMuPiK_JpsiMass = 0;
   KaonE_MuMuPiK_JpsiMass = 0;
   Muon1Px_MuMuPiK_NoMass = 0;
   Muon1Py_MuMuPiK_NoMass = 0;
   Muon1Pz_MuMuPiK_NoMass = 0;
   Muon1E_MuMuPiK_NoMass = 0;
   Muon2Px_MuMuPiK_NoMass = 0;
   Muon2Py_MuMuPiK_NoMass = 0;
   Muon2Pz_MuMuPiK_NoMass = 0;
   Muon2E_MuMuPiK_NoMass = 0;
   PionPx_MuMuPiK_NoMass = 0;
   PionPy_MuMuPiK_NoMass = 0;
   PionPz_MuMuPiK_NoMass = 0;
   PionE_MuMuPiK_NoMass = 0;
   KaonPx_MuMuPiK_NoMass = 0;
   KaonPy_MuMuPiK_NoMass = 0;
   KaonPz_MuMuPiK_NoMass = 0;
   KaonE_MuMuPiK_NoMass = 0;
   Muon1Px_MuMuPiK_B0Mass_rel = 0;
   Muon1Py_MuMuPiK_B0Mass_rel = 0;
   Muon1Pz_MuMuPiK_B0Mass_rel = 0;
   Muon1E_MuMuPiK_B0Mass_rel = 0;
   Muon2Px_MuMuPiK_B0Mass_rel = 0;
   Muon2Py_MuMuPiK_B0Mass_rel = 0;
   Muon2Pz_MuMuPiK_B0Mass_rel = 0;
   Muon2E_MuMuPiK_B0Mass_rel = 0;
   PionPx_MuMuPiK_B0Mass_rel = 0;
   PionPy_MuMuPiK_B0Mass_rel = 0;
   PionPz_MuMuPiK_B0Mass_rel = 0;
   PionE_MuMuPiK_B0Mass_rel = 0;
   KaonPx_MuMuPiK_B0Mass_rel = 0;
   KaonPy_MuMuPiK_B0Mass_rel = 0;
   KaonPz_MuMuPiK_B0Mass_rel = 0;
   KaonE_MuMuPiK_B0Mass_rel = 0;
   Muon1Px_MuMuPiK_JpsiMass_rel = 0;
   Muon1Py_MuMuPiK_JpsiMass_rel = 0;
   Muon1Pz_MuMuPiK_JpsiMass_rel = 0;
   Muon1E_MuMuPiK_JpsiMass_rel = 0;
   Muon2Px_MuMuPiK_JpsiMass_rel = 0;
   Muon2Py_MuMuPiK_JpsiMass_rel = 0;
   Muon2Pz_MuMuPiK_JpsiMass_rel = 0;
   Muon2E_MuMuPiK_JpsiMass_rel = 0;
   PionPx_MuMuPiK_JpsiMass_rel = 0;
   PionPy_MuMuPiK_JpsiMass_rel = 0;
   PionPz_MuMuPiK_JpsiMass_rel = 0;
   PionE_MuMuPiK_JpsiMass_rel = 0;
   KaonPx_MuMuPiK_JpsiMass_rel = 0;
   KaonPy_MuMuPiK_JpsiMass_rel = 0;
   KaonPz_MuMuPiK_JpsiMass_rel = 0;
   KaonE_MuMuPiK_JpsiMass_rel = 0;
   B0Mass = 0;
   B0Px = 0;
   B0Py = 0;
   B0Pz = 0;
   ...
   fChain->SetBranchAddress("genEvtVtx_particles", &genEvtVtx_particles, &b_genEvtVtx_particles);
   fChain->SetBranchAddress("n_B0Ancestors", &n_B0Ancestors, &b_n_B0Ancestors);
   fChain->SetBranchAddress("nMCAll", &nMCAll, &b_nMCAll);
   fChain->SetBranchAddress("MCPdgIdAll", &MCPdgIdAll, &b_MCPdgIdAll);
   fChain->SetBranchAddress("MCDanNumAll", &MCDanNumAll, &b_MCDanNumAll);
   ...
   fChain->SetBranchAddress("MCpsi2SMass", &MCpsi2SMass, &b_MCpsi2SMass);
   ...
   fChain->SetBranchAddress("MCkaonStarPx", &MCkaonStarPx, &b_MCkaonStarPx);
   fChain->SetBranchAddress("MCkaonStarPy", &MCkaonStarPy, &b_MCkaonStarPy);
   fChain->SetBranchAddress("MCkaonStarPz", &MCkaonStarPz, &b_MCkaonStarPz);
   fChain->SetBranchAddress("MCkaonStarCh", &MCkaonStarCh, &b_MCkaonStarCh);
   fChain->SetBranchAddress("MCkaonStarMass", &MCkaonStarMass, &b_MCkaonStarMass);
   ...
   fChain->SetBranchAddress("B0Mass_B0const", &B0Mass_B0const, &b_B0Mass_B0const);
   fChain->SetBranchAddress("B0Mass_Jpsiconst", &B0Mass_Jpsiconst, &b_B0Mass_Jpsiconst);
   ...
   fChain->SetBranchAddress("Muon1Px_MuMuPiK_JpsiMass", &Muon1Px_MuMuPiK_JpsiMass, &b_Muon1Px_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("Muon1Py_MuMuPiK_JpsiMass", &Muon1Py_MuMuPiK_JpsiMass, &b_Muon1Py_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("Muon1Pz_MuMuPiK_JpsiMass", &Muon1Pz_MuMuPiK_JpsiMass, &b_Muon1Pz_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("Muon1E_MuMuPiK_JpsiMass", &Muon1E_MuMuPiK_JpsiMass, &b_Muon1E_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("Muon2Px_MuMuPiK_JpsiMass", &Muon2Px_MuMuPiK_JpsiMass, &b_Muon2Px_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("Muon2Py_MuMuPiK_JpsiMass", &Muon2Py_MuMuPiK_JpsiMass, &b_Muon2Py_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("Muon2Pz_MuMuPiK_JpsiMass", &Muon2Pz_MuMuPiK_JpsiMass, &b_Muon2Pz_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("Muon2E_MuMuPiK_JpsiMass", &Muon2E_MuMuPiK_JpsiMass, &b_Muon2E_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("PionPx_MuMuPiK_JpsiMass", &PionPx_MuMuPiK_JpsiMass, &b_PionPx_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("PionPy_MuMuPiK_JpsiMass", &PionPy_MuMuPiK_JpsiMass, &b_PionPy_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("PionPz_MuMuPiK_JpsiMass", &PionPz_MuMuPiK_JpsiMass, &b_PionPz_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("PionE_MuMuPiK_JpsiMass", &PionE_MuMuPiK_JpsiMass, &b_PionE_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("KaonPx_MuMuPiK_JpsiMass", &KaonPx_MuMuPiK_JpsiMass, &b_KaonPx_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("KaonPy_MuMuPiK_JpsiMass", &KaonPy_MuMuPiK_JpsiMass, &b_KaonPy_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("KaonPz_MuMuPiK_JpsiMass", &KaonPz_MuMuPiK_JpsiMass, &b_KaonPz_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("KaonE_MuMuPiK_JpsiMass", &KaonE_MuMuPiK_JpsiMass, &b_KaonE_MuMuPiK_JpsiMass);
   fChain->SetBranchAddress("Muon1Px_MuMuPiK_NoMass", &Muon1Px_MuMuPiK_NoMass, &b_Muon1Px_MuMuPiK_NoMass);
   fChain->SetBranchAddress("Muon1Py_MuMuPiK_NoMass", &Muon1Py_MuMuPiK_NoMass, &b_Muon1Py_MuMuPiK_NoMass);
   fChain->SetBranchAddress("Muon1Pz_MuMuPiK_NoMass", &Muon1Pz_MuMuPiK_NoMass, &b_Muon1Pz_MuMuPiK_NoMass);
   fChain->SetBranchAddress("Muon1E_MuMuPiK_NoMass", &Muon1E_MuMuPiK_NoMass, &b_Muon1E_MuMuPiK_NoMass);
   fChain->SetBranchAddress("Muon2Px_MuMuPiK_NoMass", &Muon2Px_MuMuPiK_NoMass, &b_Muon2Px_MuMuPiK_NoMass);
   fChain->SetBranchAddress("Muon2Py_MuMuPiK_NoMass", &Muon2Py_MuMuPiK_NoMass, &b_Muon2Py_MuMuPiK_NoMass);
   fChain->SetBranchAddress("Muon2Pz_MuMuPiK_NoMass", &Muon2Pz_MuMuPiK_NoMass, &b_Muon2Pz_MuMuPiK_NoMass);
   fChain->SetBranchAddress("Muon2E_MuMuPiK_NoMass", &Muon2E_MuMuPiK_NoMass, &b_Muon2E_MuMuPiK_NoMass);
   fChain->SetBranchAddress("PionPx_MuMuPiK_NoMass", &PionPx_MuMuPiK_NoMass, &b_PionPx_MuMuPiK_NoMass);
   fChain->SetBranchAddress("PionPy_MuMuPiK_NoMass", &PionPy_MuMuPiK_NoMass, &b_PionPy_MuMuPiK_NoMass);
   fChain->SetBranchAddress("PionPz_MuMuPiK_NoMass", &PionPz_MuMuPiK_NoMass, &b_PionPz_MuMuPiK_NoMass);
   fChain->SetBranchAddress("PionE_MuMuPiK_NoMass", &PionE_MuMuPiK_NoMass, &b_PionE_MuMuPiK_NoMass);
   fChain->SetBranchAddress("KaonPx_MuMuPiK_NoMass", &KaonPx_MuMuPiK_NoMass, &b_KaonPx_MuMuPiK_NoMass);
   fChain->SetBranchAddress("KaonPy_MuMuPiK_NoMass", &KaonPy_MuMuPiK_NoMass, &b_KaonPy_MuMuPiK_NoMass);
   fChain->SetBranchAddress("KaonPz_MuMuPiK_NoMass", &KaonPz_MuMuPiK_NoMass, &b_KaonPz_MuMuPiK_NoMass);
   fChain->SetBranchAddress("KaonE_MuMuPiK_NoMass", &KaonE_MuMuPiK_NoMass, &b_KaonE_MuMuPiK_NoMass);
   fChain->SetBranchAddress("Muon1Px_MuMuPiK_B0Mass_rel", &Muon1Px_MuMuPiK_B0Mass_rel, &b_Muon1Px_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("Muon1Py_MuMuPiK_B0Mass_rel", &Muon1Py_MuMuPiK_B0Mass_rel, &b_Muon1Py_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("Muon1Pz_MuMuPiK_B0Mass_rel", &Muon1Pz_MuMuPiK_B0Mass_rel, &b_Muon1Pz_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("Muon1E_MuMuPiK_B0Mass_rel", &Muon1E_MuMuPiK_B0Mass_rel, &b_Muon1E_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("Muon2Px_MuMuPiK_B0Mass_rel", &Muon2Px_MuMuPiK_B0Mass_rel, &b_Muon2Px_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("Muon2Py_MuMuPiK_B0Mass_rel", &Muon2Py_MuMuPiK_B0Mass_rel, &b_Muon2Py_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("Muon2Pz_MuMuPiK_B0Mass_rel", &Muon2Pz_MuMuPiK_B0Mass_rel, &b_Muon2Pz_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("Muon2E_MuMuPiK_B0Mass_rel", &Muon2E_MuMuPiK_B0Mass_rel, &b_Muon2E_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("PionPx_MuMuPiK_B0Mass_rel", &PionPx_MuMuPiK_B0Mass_rel, &b_PionPx_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("PionPy_MuMuPiK_B0Mass_rel", &PionPy_MuMuPiK_B0Mass_rel, &b_PionPy_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("PionPz_MuMuPiK_B0Mass_rel", &PionPz_MuMuPiK_B0Mass_rel, &b_PionPz_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("PionE_MuMuPiK_B0Mass_rel", &PionE_MuMuPiK_B0Mass_rel, &b_PionE_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("KaonPx_MuMuPiK_B0Mass_rel", &KaonPx_MuMuPiK_B0Mass_rel, &b_KaonPx_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("KaonPy_MuMuPiK_B0Mass_rel", &KaonPy_MuMuPiK_B0Mass_rel, &b_KaonPy_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("KaonPz_MuMuPiK_B0Mass_rel", &KaonPz_MuMuPiK_B0Mass_rel, &b_KaonPz_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("KaonE_MuMuPiK_B0Mass_rel", &KaonE_MuMuPiK_B0Mass_rel, &b_KaonE_MuMuPiK_B0Mass_rel);
   fChain->SetBranchAddress("Muon1Px_MuMuPiK_JpsiMass_rel", &Muon1Px_MuMuPiK_JpsiMass_rel, &b_Muon1Px_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("Muon1Py_MuMuPiK_JpsiMass_rel", &Muon1Py_MuMuPiK_JpsiMass_rel, &b_Muon1Py_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("Muon1Pz_MuMuPiK_JpsiMass_rel", &Muon1Pz_MuMuPiK_JpsiMass_rel, &b_Muon1Pz_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("Muon1E_MuMuPiK_JpsiMass_rel", &Muon1E_MuMuPiK_JpsiMass_rel, &b_Muon1E_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("Muon2Px_MuMuPiK_JpsiMass_rel", &Muon2Px_MuMuPiK_JpsiMass_rel, &b_Muon2Px_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("Muon2Py_MuMuPiK_JpsiMass_rel", &Muon2Py_MuMuPiK_JpsiMass_rel, &b_Muon2Py_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("Muon2Pz_MuMuPiK_JpsiMass_rel", &Muon2Pz_MuMuPiK_JpsiMass_rel, &b_Muon2Pz_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("Muon2E_MuMuPiK_JpsiMass_rel", &Muon2E_MuMuPiK_JpsiMass_rel, &b_Muon2E_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("PionPx_MuMuPiK_JpsiMass_rel", &PionPx_MuMuPiK_JpsiMass_rel, &b_PionPx_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("PionPy_MuMuPiK_JpsiMass_rel", &PionPy_MuMuPiK_JpsiMass_rel, &b_PionPy_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("PionPz_MuMuPiK_JpsiMass_rel", &PionPz_MuMuPiK_JpsiMass_rel, &b_PionPz_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("PionE_MuMuPiK_JpsiMass_rel", &PionE_MuMuPiK_JpsiMass_rel, &b_PionE_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("KaonPx_MuMuPiK_JpsiMass_rel", &KaonPx_MuMuPiK_JpsiMass_rel, &b_KaonPx_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("KaonPy_MuMuPiK_JpsiMass_rel", &KaonPy_MuMuPiK_JpsiMass_rel, &b_KaonPy_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("KaonPz_MuMuPiK_JpsiMass_rel", &KaonPz_MuMuPiK_JpsiMass_rel, &b_KaonPz_MuMuPiK_JpsiMass_rel);
   fChain->SetBranchAddress("KaonE_MuMuPiK_JpsiMass_rel", &KaonE_MuMuPiK_JpsiMass_rel, &b_KaonE_MuMuPiK_JpsiMass_rel);
   ...
   fChain->SetBranchAddress("nB0massconst_notvalid", &nB0massconst_notvalid, &b_nB0massconst_notvalid);
...
void KinFitCheck::Show(Long64_t entry)
{
...
Int_t KinFitCheck::Cut(Long64_t entry)
{
