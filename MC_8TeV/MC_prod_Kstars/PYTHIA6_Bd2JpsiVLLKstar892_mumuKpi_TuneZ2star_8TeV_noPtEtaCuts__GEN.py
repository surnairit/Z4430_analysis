...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('B0 -> J/psiK*892 -> mumuK+pi- at 8TeV'),
    name = cms.untracked.string('$Source: /afs/cern.ch/user/l/lecriste/sanjay_code/CMSSW_5_3_22/src/Configuration/GenProduction/python/PYTHIA6_Bd2JpsiVLLKstar892_mumuKpi_TuneZ2star_8TeV_noPtEtaCuts_cff.py,v $')
)
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
            ...
            user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/B0_JpsiKstar_892_mumuKpi.dec'),
