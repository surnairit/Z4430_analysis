...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(100000)   #100000
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('B0 -> J/psiK*_0_1430 -> mumuK+pi- at 8TeV'),
    name = cms.untracked.string('$Source: /afs/cern.ch/user/l/lecriste/sanjay_code/CMSSW_5_3_22/src/Configuration/GenProduction/python/PYTHIA6_Bd2JpsiVLLKstar_0_1430_mumuKpi_TuneZ2star_8TeV_noPtEtaCuts_cff.py,v $')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #fileName = cms.untracked.string('PYTHIA6_Bd2JpsiVLLKstar892_mumuKpi_TuneZ2star_8TeV_noPtEtaCuts__GEN.root'),
    fileName = cms.untracked.string('PYTHIA6_Bd2JpsiVLLKstar_0_1430_mumuKpi_TuneZ2star_8TeV_noPtEtaCuts__GEN.root'),
...
process.kstardecayfilter = cms.EDFilter("PythiaDauVFilter",
    verbose         = cms.untracked.int32(0),
    NumberDaughters = cms.untracked.int32(2),
    ParticleID      = cms.untracked.int32(10311), #K* monte carlo ID
...
process.decayfilter = cms.EDFilter("PythiaDauVFilter",
    ...
    DaughterIDs = cms.untracked.vint32(443, 10311), #B0 daughter id
    NumberDaughters = cms.untracked.int32(2),
    verbose = cms.untracked.int32(0)
)
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
            ...
            user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/B0_JpsiKstar_0_1430_mumuKpi.dec'),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.bfilter+process.decayfilter+process.psifilter+process.kstardecayfilter)
