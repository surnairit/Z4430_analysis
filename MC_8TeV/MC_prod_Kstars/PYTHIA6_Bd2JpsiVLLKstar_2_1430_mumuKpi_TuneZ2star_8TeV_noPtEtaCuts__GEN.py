...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('B0 -> J/psiK*_2_1430 -> mumuK+pi- at 8TeV'),
    name = cms.untracked.string('$Source: /afs/cern.ch/user/l/lecriste/sanjay_code/CMSSW_5_3_22/src/Configuration/GenProduction/python/PYTHIA6_Bd2JpsiVLLKstar_2_1430_mumuKpi_TuneZ2star_8TeV_noPtEtaCuts_cff.py,v $')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Bd2JpsiVLLKstar_2_1430_mumuKpi_TuneZ2star_8TeV_noPtEtaCuts__GEN.root'),
...
process.kstardecayfilter = cms.EDFilter("PythiaDauVFilter",
    ...
    ParticleID      = cms.untracked.int32(315), #K* monte carlo ID
...
process.decayfilter = cms.EDFilter("PythiaDauVFilter",
    ...
    DaughterIDs = cms.untracked.vint32(443, 315), #B0 daughter id
    NumberDaughters = cms.untracked.int32(2),
    verbose = cms.untracked.int32(0)
)
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
            ...
            user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/B0_JpsiKstar_2_1430_mumuKpi.dec'),
