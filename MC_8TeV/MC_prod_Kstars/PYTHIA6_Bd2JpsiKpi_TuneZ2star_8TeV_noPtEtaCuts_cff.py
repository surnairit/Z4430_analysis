...
generator = cms.EDFilter(
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bd_JpsiKpi.dec'),
...
decayfilter = cms.EDFilter(
	...
	ParticleID      = cms.untracked.int32(511),  
        DaughterIDs     = cms.untracked.vint32(443, 321, -211),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/n/nsur/work/scratch0/BPH/MC_8TeV/MC_request_B0JPsiKPi/CMSSW_5_3_22/src/Configuration/GenProduction/python/PYTHIA6_Bd2JpsiKpi_TuneZ2star_8TeV_noPtEtaCut_cff.py,v $'),    
    annotation = cms.untracked.string('B0 -> JpsiK+pi- at 8TeV')
    )
