...
// Wed Jul 15 14:47:22 2015 by ROOT version 5.32/00
// from TTree Z_data/Z(4430) Data
// found on file: MuOniaParked_Run2012C_22Jan2013v1_MuMuPiKPAT_0000.root
//////////////////////////////////////////////////////////

#ifndef SignalExtract_Jpsi_h
#define SignalExtract_Jpsi_h
...
class SignalExtract_Jpsi : public TSelector {
public :
   ...
   SignalExtract_Jpsi(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~SignalExtract_Jpsi() { }
   ...
   ClassDef(SignalExtract_Jpsi,0);

};

#endif

#ifdef SignalExtract_Jpsi_cxx
void SignalExtract_Jpsi::Init(TTree *tree)
{
  ...
  double jpsi_mass = 3.0967;
  double psi2S_mass = 3.686109 ;
  double pionCh_mass = 0.13957018;
...
Bool_t SignalExtract_Jpsi::Notify()
{
...
#endif // #ifdef SignalExtract_Jpsi_cxx
