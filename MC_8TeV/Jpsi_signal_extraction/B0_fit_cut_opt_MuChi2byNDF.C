...
//  TFile *f0 = new TFile("psi2spipi_cut_opt_trial.root");
  ...
  TFile *f0 = new TFile("MuMuPiK_Jpsi_output_new_comb_MuChi2_by_NDF.root");
  ofstream outfile;
  outfile.open("purity_MuChi2byNDF.txt");
...
//  RooRealVar s("s","s",0.006,0.005,0.018);
  RooRealVar s("s","s",0.0105,0.005,0.012);
//  RooRealVar s2("s2","s2",0.015,0.01,0.035);
...
//  gr->GetXaxis()->SetTitle("ChiSquared/NDoF cut ");
  ...
  c_purity->SaveAs("purity_MuChi2_NDF.pdf");
