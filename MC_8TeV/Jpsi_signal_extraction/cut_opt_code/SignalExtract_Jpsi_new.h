...
// Fri Jul 24 01:29:09 2015 by ROOT version 5.32/00
// from TTree Z_data/Z(4430) Data
// found on file: MuOniaRun2012D_25Apr_MuMuPiPiPAT_first10files.root
//////////////////////////////////////////////////////////

#ifndef SignalExtract_Jpsi_new_h
#define SignalExtract_Jpsi_new_h
...
class SignalExtract_Jpsi_new : public TSelector {
public :
   ...
   SignalExtract_Jpsi_new(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~SignalExtract_Jpsi_new() { }
...
//   TH1F* hjpsiKPiMassSelAltZoom_MuChi2_by_NDF[10];
//   TH1F* hjpsiKPiMassSelAltZoom_MuS_hits[21];
//   TH1F* hjpsiKPiMassSelAltZoom_MuP_hits[11];
//   TH1F* hjpsiKPiMassSelAltZoom_MuDz[51];
//   TH1F* hjpsiKPiMassSelAltZoom_MuDxy[11];

//    TH1F* hjpsiKPiMassSelAltZoom_B0CosAlphaPV[10];
...
//     TH1F* hjpsiKPiMassSelAltZoom_B0Pt[20];
    TH1F* hjpsiKPiMassSelAltZoom_trackPt[20];
   ...
   Double_t muon_mass, phi_mass, jpsi_mass, psi2S_mass, pionCh_mass, kaonCh_mass;


   ClassDef(SignalExtract_Jpsi_new,0);
};

#endif

#ifdef SignalExtract_Jpsi_new_cxx
void SignalExtract_Jpsi_new::Init(TTree *tree)
{
...
Bool_t SignalExtract_Jpsi_new::Notify()
{
...
#endif // #ifdef SignalExtract_Jpsi_new_cxx
