...
{ // main
  ...
  TFile *f0 = new TFile("MuMuPiK_Jpsi_output_new_comb_trackPtrelaxed_B0Ptrelaxed_nB0eq1.root");
  ofstream outfile;
  outfile.open("purity_trackptrelaxed_B0Ptrelaxed_nB0eq1.txt");
...
//  RooRealVar s2("s2","s2",0.015,0.01,0.07);
  ...
  RooRealVar nsig("nsig","nsig",10000,50,15000); // 10000,100,15000
  RooRealVar nbkg("nbkg","nbkg",3000,20,50000); // 3000,100,50000
