...
//  TFile *f0 = new TFile("psi2spipi_cut_opt_trial.root");
  ...
  TFile *f0 = new TFile("MuMuPiK_Jpsi_output_new_comb_B0CosAlphaPV.root");
  ofstream outfile;
  outfile.open("purity_B0CosAlphaPV.txt");
...
//  gr->GetXaxis()->SetTitle("ChiSquared/NDoF cut ");
  ...
  c_purity->SaveAs("purity_B0CosAlphaPV.pdf");
