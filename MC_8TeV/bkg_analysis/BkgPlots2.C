{
    ...
    l->SetTextSize(0.025);
    l->Draw();
    c11->SaveAs("Bkg_B0_MuMuPiPi_compare.png");
    f1->Close();
    ...
    hjpsiPiPiMassNoPhi_discard->Draw("same");
    l->Draw();
    c21->SaveAs("Bkg_Bp_MuMuPiPi_compare.png");
    f2->Close();
    ...
    hjpsiPiPiMassNoPhi_discard->Draw("same");
    l->Draw();
    c31->SaveAs("Bkg_Bs_MuMuPiPi_compare.png");
    f3->Close();
    ...
    hjpsiPiPiMassNoPhi_discard->Draw("same");
    l->Draw();
    c41->SaveAs("Bkg_LambdaB_MuMuPiPi_compare.png");
