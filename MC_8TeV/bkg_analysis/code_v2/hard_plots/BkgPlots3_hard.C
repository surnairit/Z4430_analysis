{
    ...
    l->SetTextSize(0.025);
    l->Draw();
    c11->SaveAs("Bkg_B0_MuMuPiPi_noK892_compare_hard.png");
    f1->Close();
    ...
    hjpsiPiPiMass_noK892_discard_hard->Draw("same");
    l->Draw();
    c21->SaveAs("Bkg_Bp_MuMuPiPi_noK892_compare_hard.png");
    f2->Close();
    ...
    hjpsiPiPiMass_noK892_discard_hard->Draw("same");
    l->Draw();
    c31->SaveAs("Bkg_Bs_MuMuPiPi_noK892_compare_hard.png");
    f3->Close();
    ...
    hjpsiPiPiMass_noK892_discard_hard->Draw("same");
    l->Draw();
    c41->SaveAs("Bkg_LambdaB_MuMuPiPi_noK892_compare_hard.png");
