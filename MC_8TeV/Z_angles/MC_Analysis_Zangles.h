...
#ifndef MC_Analysis_Zangles_h
#define MC_Analysis_Zangles_h
...
class MC_Analysis_Zangles : public TSelector {
    public :
    ...
    MC_Analysis_Zangles(TTree * /*tree*/ =0) : fChain(0) { }
    virtual ~MC_Analysis_Zangles() { }
...
#ifdef MC_Analysis_Zangles_cxx
void MC_Analysis_Zangles::Init(TTree *tree)
{
...
Bool_t MC_Analysis_Zangles::Notify()
{
...
#endif // #ifdef MC_Analysis_Zangles_cxx
